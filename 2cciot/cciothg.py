...
class HTMLGenerator:
    ...
    def __init__(self, markdown_file):
        ...
        self.extract_chapter_and_section()  # 初始化时就提取出来

    def extract_chapter_and_section(self):
...
'''
    ...
    def process_navigation_and_questions(self, block):
        ...
        self.chapter_number_0 = f"{int(self.chapter_number):02d}"
    ...
    <iframe
    src           = "img/c{self.chapter_number_0}/mindmap-{self.chapter_number}-{self.section_number}.html"
...
[ {self.section}](cciot-{self.chapter_number}-{self.section_number}.html#/overview)
[| 练习 |](cciot-exec.html)
[ {self.section}](cciot-{self.chapter_number}-{self.section_number}.html#/overview)
...
if __name__ == "__main__":
    markdown_file = input("Input the Markdown filename please:") + ".md"
