...
})();hljs.registerLanguage("xml",e)})();/*! `plaintext` grammar compiled for Highlight.js 11.3.1 */
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `python` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("python",e)})();/*! `swift` grammar compiled for Highlight.js 11.3.1 */
...
;hljs.registerLanguage("makefile",e)})();/*! `csharp` grammar compiled for Highlight.js 11.3.1 */
